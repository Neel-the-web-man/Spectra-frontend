      ...
      <div className="content">
        ...
        <div className="right">
          ...
          <div className="inf">
            ...
            <ul className="list">
              {movie.languages.map((item, index) => <li key={index}>{item}
              </li>)}
            </ul>
          </div>
          <div className="inf">
          ...
          <div className="inf">
            ...
            <ul className="list">
              {movie.cast.map((item, index) => <li key={index}>{item}</li>)}
            </ul>
          </div>
          <div className="inf">
            <span className="hl">Directed by:</span>
            <ul className="list">
              {movie.directors.map((item, index) => <li key={index}>{item}
              </li>)}
            </ul>
          </div>
          <div className="inf">
            <span className="hl">IMDb rating:</span> {movie.imdb.rating}{" "}
